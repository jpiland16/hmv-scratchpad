...
# On 1st pass dt evidently can't be computed. A notional value of 100(micro)s is
...
class DeltaT():
    ...
    def __call__(self, ts):
        ...
        if self.start_time is None:  # 1st call: self.start_time is invalid
            self.start_time = ts
            return 0.0001  # 100(micro)s notional delay. 1st reading is invalid in any case
